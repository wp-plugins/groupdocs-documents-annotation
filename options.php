...
if (isset ($_POST['login']) && ($_POST['password'])) {
    ...
    if ($userData->status == "Ok") {
        ...
        ?>
        <div class="updated"><p><strong><?php _e('Entered confirm Login and Password!', 'menu-test' ); ?></strong></p></div>
    <?php
    }
...
//  If data was posted to the page...
    if( isset($_POST['grpdocs_annotation_submit_hidden']) && $_POST['grpdocs_annotation_submit_hidden'] == 1) {
...
<div>
    ...
    <form name="form_annotation" method="post" action="">
	...
	<form name="form" method="post" action="">
		...
		<input type="hidden" name="grpdocs_annotation_submit_hidden" value="1">
