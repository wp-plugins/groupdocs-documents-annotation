...
function grpdocs_annotation_getdocument($atts) {
	...
	$code = "<iframe src='http://apps.groupdocs.com/document-annotation/embed/{$guid}?&referer=wordpress-annotation/1.3.7&use_pdf=true' frameborder='0' width='{$width}' height='{$height}'>{$no_iframe}</iframe>";
