...
function grpdocs_annotation_getdocument($atts) {
	...
	$code = "<iframe src='http://apps.groupdocs.com/document-annotation/embed/{$guid}?&referer=wordpress/1.3.6&use_pdf=true' frameborder='0' width='{$width}' height='{$height}'></iframe>";
