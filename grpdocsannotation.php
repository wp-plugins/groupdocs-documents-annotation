...
function grpdocs_annotation_getdocument($atts) {
	...
	$code = "<iframe src='https://apps.groupdocs.com/document-annotation/embed/{$file}&referer=wordpress-annotation/1.3.6&use_pdf=true' frameborder='0' width='{$width}' height='{$height}'>{$no_iframe}</iframe>";
